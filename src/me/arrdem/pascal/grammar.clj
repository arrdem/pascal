...
(declare
    ...
    constant-declaration tag-field type record-variable-list program-heading
...
(defrule tok_forward (fnp/lit "forward"))
...
(defrule formal-parameter-section
  (fnp/alt
    ...
    (fnp/conc tok_function identifier (fnp/opt parameters) tok_COL typeid)))
